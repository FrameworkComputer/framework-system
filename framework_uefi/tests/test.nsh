...
echo ""
echo "=== TEST: introspect (may fail in QEMU without real SMBIOS) ==="
%fwk% --introspect
# Don't fail on this - QEMU doesn't have real Framework SMBIOS
echo "TEST_INFO: introspect exited with %lasterror%"
