...
complete -c framework_tool -l thermalget -d 'Print thermal thresholds of the temperature sensors'
...
complete -c framework_tool -l switches -d 'Show current EC switch positions (lid, power button, ...)'
complete -c framework_tool -l port80read -d 'Show history of port 80 writes (POST codes)'
complete -c framework_tool -l panicinfo -d 'Show saved EC panic info'
complete -c framework_tool -l wifisar -d 'Show Wi-Fi SAR power limits from UEFI variables (WRDS, EWRD)'
